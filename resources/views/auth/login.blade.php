...
<body class="min-h-screen bg-slate-900 font-[Poppins] text-white antialiased relative overflow-hidden">
    ...
    <div
        class="absolute bottom-0 right-0 w-96 h-96 bg-blue-600 rounded-full blur-3xl opacity-20 glow-effect animation-delay-5000">
    </div>

    <div class="relative min-h-screen flex items-center justify-center p-4">

        <div
            class="grid lg:grid-cols-2 items-center w-full max-w-sm lg:max-w-4xl bg-slate-800/50 backdrop-blur-lg rounded-3xl shadow-2xl border border-slate-700 overflow-hidden animate-[fadeIn_0.7s_ease-out]">

            <!-- Welcome Section -->
            <div class="hidden lg:flex flex-col justify-center items-center h-full p-12 welcome-bg text-center">
                <img src="{{ asset('images/logo.png') }}" alt="Logo"
                    class="h-24 w-auto drop-shadow-lg mb-4 animate-float">
                <h2 class="text-3xl font-bold tracking-wide">Selamat Datang Kembali</h2>
                <p class="mt-3 text-indigo-200">Kelola bisnis laundry Anda dengan mudah dan efisien bersama Avachive.
                </p>
            </div>
            ...
            <div class="w-full p-6 md:p-8 lg:p-12">
                <div class="text-center lg:hidden mb-6">
                    <img src="{{ asset('images/logo.png') }}" alt="Logo"
                        class="h-16 w-auto mx-auto drop-shadow-lg animate-float">
                </div>
                <h1 class="text-2xl sm:text-3xl font-bold text-center">Login Akun</h1>
                <p class="mt-2 text-sm text-slate-400 text-center">Silakan masukkan kredensial Anda.</p>

                <div class="mt-8">
                    <x-auth-session-status class="mb-4 bg-green-500/20 text-green-300 p-3 rounded-lg text-sm"
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <input id="remember_me" type="checkbox"
                                    class="h-4 w-4 text-indigo-500 focus:ring-indigo-500 border-slate-500 rounded bg-slate-700">
