...
<head>
    ...
    <title>Laporan Pemasukan - Avachive Admin</title>
    ...
    <style>
        ...
        #orderTable thead th { font-weight: 600; text-align: left; padding: 1rem 1.25rem; color: #475569; /* slate-600 */ background-color: #f8fafc; /* slate-50 */ border-bottom: 2px solid #e2e8f0; /* slate-200 */ white-space: nowrap; }
        #orderTable tbody td { padding: 1rem 1.25rem; color: #334155; /* slate-700 */ vertical-align: middle; border-bottom: 1px solid #f1f5f9; /* slate-100 */ white-space: nowrap; }
        ...
        /* === PENAMBAHAN: CSS UNTUK PAGINATION === */
        #orderTable_wrapper .dt-paging .dt-paging-button { border: 1px solid #cbd5e1 !important; transition: all 0.15s ease-in-out !important; font-weight: 600 !important; border-radius: 0.5rem !important; margin: 0 3px !important; padding: 0.5em 1em !important; background: #fff !important; color: #334155 !important; }
        #orderTable_wrapper .dt-paging .dt-paging-button:not(.disabled):hover { background-color: #f1f5f9 !important; border-color: #94a3b8 !important; }
        #orderTable_wrapper .dt-paging .dt-paging-button.current { background-color: #14b8a6 !important; color: #ffffff !important; border-color: #14b8a6 !important; }
        #orderTable_wrapper .dt-paging .dt-paging-button.disabled { color: #94a3b8 !important; background-color: #f8fafc !important; }
    </style>
</head>

<body class="bg-slate-100 text-slate-800 antialiased">
    <div class="relative flex h-screen bg-slate-100">
        <aside id="sidebar" class="w-64 bg-slate-900 text-slate-300 p-4 flex-col fixed inset-y-0 left-0 z-30 transition-transform duration-300 ease-in-out hidden md:flex" aria-label="Sidebar Navigasi">
                            ...
                            <table id="orderTable" class="w-full text-sm">
                               ...
                               <tfoot class="bg-slate-50 font-bold">
                                    <tr>
                                        ...
                                        <th colspan="2" class="p-4 text-right text-slate-800 text-base">Total Pemasukan (Filter)</th>
    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 h-20 bg-white shadow-[0_-2px_10px_rgba(0,0,0,0.1)] z-30 flex justify-around items-center px-2">
        ...
        <a href="{{ route('dataorder') }}" class="flex flex-col items-center gap-1 text-teal-500 font-semibold">
    ...
    $(document).ready(function() {
        ...
        function initDataTable() {
            table = $('#orderTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                responsive: false, // Diubah ke false agar bisa scroll horizontal
                ajax: {
                    url: API_URL_DATA,
                    type: "POST",
